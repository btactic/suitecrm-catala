...
$mod_strings = array (
	...
	'LBL_DISCLOSURE_TITLE'						=> 'Afegir missatge sobre confidencialitat de contingut a cada correu electrònic',
	'LBL_DISCLOSURE_TEXT_TITLE'					=> 'Confidencialitat de Contingut',
	'LBL_DISCLOSURE_TEXT_SAMPLE'				=> 'AVÍS: Aquest missatge de correu electrònic és per a ús únic del destinatari(s) i pot contenir informació privada i confidencial. Queda prohibit qualsevol tipus de revisió, ús, revelació o distribució no autoritzada. Si vostè no és el destinatari previst, si us plau, destrueixi totes les còpies del missatge original i notifiqui el remitent de manera que puguem corregir la direcció de correu en el nostre registre. Gràcies.',
	
	'LBL_EMAIL_DEFAULT_CHARSET'					=> 'Redactar missatges de correu electrònic en aquest joc de caràcters',
	'LBL_EMAIL_DEFAULT_EDITOR'					=> 'Redactar correu electrònic fent servir aquest client',
	...
	'LBL_EMAIL_USER_TITLE'						=> 'Correu electrònic per defecte per l\'usuari',
	...
	'LBL_LIST_FROM_EMAIL'						=> 'Correu electrònic del remitent',
	...
	'LBL_VIEW_PROCESSED_EMAILS'					=> 'Veure correus electrònics processats',
	'LBL_VIEW_QUEUED_EMAILS'					=> 'Veure correus electrònics en cua',
	...
	'LBL_NOTIFY_SEND_FROM_ASSIGNING_USER'		=> 'Enviar notificació usant com a remitent la direcció de correu electrònic de l\'usuari assignador?',
