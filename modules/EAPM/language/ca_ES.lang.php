...
$mod_strings = array (
  ...
  'LBL_ACTIVE' => 'Comptes de Correu Actives',
  'LBL_OAUTH_NAME' => '%s',
  'LBL_SUGAR_USER_NAME' => 'Usuari de SuiteCRM',
  'LBL_DISPLAY_PROPERTIES' => 'Veure propietats',
  ...
  'LBL_MEET_NOW_BUTTON' => 'Reunir-se ara',
  'LBL_VIEW_LOTUS_LIVE_MEETINGS' => 'Veure pròximes reunions d\'IBM SmartCloud&trade;',
  'LBL_TITLE_LOTUS_LIVE_MEETINGS' => 'Pròximes reunions d\'IBM SmartCloud&trade;',
  'LBL_VIEW_LOTUS_LIVE_DOCUMENTS' => 'Veure fitxers d\'IBM SmartCloud&trade;',
  'LBL_TITLE_LOTUS_LIVE_DOCUMENTS' => 'Fitxers d\'IBM SmartCloud&trade;',
  ...
  'LBL_ERR_FACEBOOK' => 'Facebook ha tornat un error, i la informació no es pot mostrar.',
    'LBL_ERR_OAUTH_FACEBOOK_1' => 'L\'autenticació de Facebook ha fallat. Per intentar l\'autenticació, si us plau',
    'LBL_ERR_OAUTH_FACEBOOK_2' => 'torni a iniciar la sessió de Facebook',
  'LBL_ERR_NO_RESPONSE' => 'S\'ha produït un error al intentar connectar-se a aquest compte.',
  'LBL_ERR_TWITTER' => 'Twitter ha tornat un error, i la informació no es pot mostrar.',
  'LBL_ERR_POPUPS_DISABLED' => 'Si us plau, activi les finestres emergents del navegador o afegeixi una excepció per al lloc web "{0}" a la llista d\'excepcions amb l\'objectiu de connectar.'
);
