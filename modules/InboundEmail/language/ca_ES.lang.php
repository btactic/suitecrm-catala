...
$mod_strings = array(
	...
	'LBL_ASSIGN_TO_GROUP_FOLDER_DESC'=> 'Seleccioni aquesta opció per a que es creïn automàticament registres de correu a SuiteCRM per a tots els correus entrants.',
    ...
    'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'Quan se selecciona aquesta opció, el Nom i Adreça del remitent associats al compte de correu d\'aquest grup apareixeran com una opció per al camp "De" a l\'escriu-re un correu per als usuaris que tinguin accés al compte de correu del grup.',
