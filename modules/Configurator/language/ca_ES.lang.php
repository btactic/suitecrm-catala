...
//	'EXPORT_DELIMITER' => 'Delimitador per Exportació',
	'IMAGES'=>'Logos',
	'LBL_ADMIN_WIZARD' => 'Assistent d\'administració',
	...
	'LBL_PORTAL_ON_DESC' => 'Permet als usuaris administrar informació del portal d\'usuari relativa als registres dels contactes. Els usuaris del portal poden accedir a Casos, Incidències, articles de bases de coneixements i altres dades a través de l\'aplicació del portal de SuiteCRM.',
	...
	'LBL_SKYPEOUT_ON_DESC' => 'Permet als usuaris fer clic en els números de telèfon per realitzar trucades utilitzant SkypeOut&reg;. Els números han d\'estar formatats degudament per utilitzar aquesta funcionalitat. El número ha de tenir el format: " + "Codi País" "Número", com a +34 965 555 555. Per a més informació, vegi el FAQ de Skype en  <a href="http://www.skype.com/help/faq/skypeout.html#calling" target="skype">FAQ de Skype&reg;</a>	',
    ...
    'LOCK_HOMEPAGE_HELP'=>'Aquesta opció serveix per <BR> 1) la creació de noves pàgines d\'inici en el mòdul Inici, i <BR>2) la personalització de la ubicació del dashlet en les pàgines d\'inici usant arrossegar i soltar.',
    'CURRENT_LOGO'=>'Logo actual',
    'CURRENT_LOGO_HELP'=>'Aquest logotip apareix a la cantonada esquerra del peu de pàgina de l\'aplicació SuiteCRM.',
    ...
    'NEW_LOGO_HELP_NO_SPACE'=>'El format de la imatge pot ser .png o .jpg. L\'altura màxima és de 17px, i l\'amplada màxima és de 450px. Qualsevol imatge pujada que superi alguna de les mides serà escalada a les dimensions màximes. El nom del fitxer de la imatge no pot contenir espais.',
    ...
    'LBL_LDAP_ADMIN_USER_DESC'=>'Utilitzat per a cercar l\'usuari de SuiteCRM. [És possible que hagi de ser totalment certificat] La connexió serà anònima si no es proporciona.',
    'LBL_LDAP_ADMIN_PASSWORD'=> 'Contrasenya:',
	'LBL_LDAP_AUTHENTICATION'=> 'Autentificació:',
	'LBL_LDAP_AUTHENTICATION_DESC'=>'Enllaçar amb el servidor LDAP utilitzant les credencials especifiques dels usuaris',
	...
	'LBL_LDAP_USER_FILTER_DESC'=>'Qualsevol paràmetre d\'filtrat addicional a aplicar a l\'hora d\'autenticar usuaris. Per exemple:<em>is_sugar_user=1 or (is_sugar_user=1)(is_sales=1)</em>',
    ...
    'LBL_LDAP_LOGIN_ATTRIBUTE_DESC'=>'Per cercar en el servidor LDAP Exemples d\'usuari:[<b>AD:</b>&nbsp;userPrincipalName] [<b>openLDAP:</b>&nbsp;dn] [<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;dn] ',
	...
	'SHOW_DOWNLOADS_TAB_HELP' =>'Quan es selecciona, la pestanya de descarregues apareixerà a la configuració d\'usuari i permetrà als usuaris accedir als plug-ins de SuiteCRM i a d\'altres fitxers disponibles',
    ...
    'LBL_IMPORT_MAX_RECORDS_HELP' => 'Especificar quants registres es permeten dins dels arxius d\'importació. Si el nombre de registres <br>en un arxiu d\'importació excedeix aquest nombre, l\'usuari serà avisat. Si no <br>s\'entra cap nombre s\'acceptarà un nombre il·limitat de registres.',
    ...
    'PDF_CREATOR' => 'Creador de PDF',
    'PDF_CREATOR_INFO' => 'Defineix el creador del document. <br>Normalment, aquest és el nom de l\'aplicació que genera el PDF.',
    ...
    'PDF_NEW_HEADER_LOGO_INFO' => 'El formar de l\'arxiu pot ser .jpg o .ong (Solament .jpg per EZPDF)<BR> -la grandaria recomanada es 867x74 px.',

    'PDF_HEADER_LOGO_WIDTH' => 'Amplada de la imatge de pressupostos',
    'PDF_HEADER_LOGO_WIDTH_INFO' => 'Canvia l\'escala de la imatge pujada que apareix als documents PDF de pressupostos. (només TCPDF)',
    ...
    'PDF_SMALL_HEADER_LOGO_WIDTH' => 'Amplada de la imatge dels informes',
    'PDF_SMALL_HEADER_LOGO_WIDTH_INFO' => 'Modifica la escala de la imatge pujada que apareix als documents PDF d\'informes. (només TCPDF)',


    'PDF_HEADER_STRING' => 'Text de la capçalera',
    'PDF_HEADER_STRING_INFO' => 'Text de descripció de la capçalera',

    'PDF_HEADER_TITLE' => 'Títol de la capçalera',
    'PDF_HEADER_TITLE_INFO' => 'Cadena a imprimir com a títol a la capçalera del document',
    ...
    'K_TITLE_MAGNIFICATION_INFO' => 'Augment del títol respecte a la mida principal de la font.',

    'K_SMALL_RATIO' => 'Factor de lletra petita',
    'K_SMALL_RATIO_INFO' => 'Coeficient de reducció per a fonts petites.',

    'HEAD_MAGNIFICATION' => 'Augment de la capçalera',
...
"More help : www.tcpdf.org" ',
    ...
    'LBL_PDF_PATCH_INFO' => 'Modificació personalitzada de la codificació. Escriu una matriu PHP <br> Exemple :. <br> ISO-8859-1 no conté el símbol de l\'euro. Per afegir a la posició 164, escriviu "array (164 => \\ \'Euro \\\')".',
...
BSOFR',
    ...
    'LBL_FONT_MOVE_DEFFILE' => 'Mou-re l\'arxiu de definició de la font a: ',
    'LBL_FONT_MOVE_FILE' => 'Moure el fitxer font a :',

// Font manager
    'ERR_LOADFONTFILE' => 'ERROR: error al carregar el fitxer de font!',
    'ERR_FONT_EMPTYFILE' => 'ERROR: Nom d\'arxiu vuit!',
    'ERR_FONT_UNKNOW_TYPE' => 'ERROR: Tipus de font desconegut:',
    'ERR_DELETE_CORE_FILE' => 'ERROR: No es pot eliminar una font principal del sistema.',
    ...
    'ERR_FONT_FILE_DO_NOT_EXIST' => 'no existeix o no és un directori.',
    'ERR_FONT_MAKEFONT' => 'ERROR: error a MakeFont',
    'ERR_FONT_ALREADY_EXIST' => 'ERROR: Aquesta font ja existeix. Tornant a un estat anterior...',
...
// Wizard
    ...
    'LBL_WIZARD_FINISH' => 'Cliqui <b>Continuar</b> per a configurar les seves opcions d\'usuari.<br/><br />Per a configurar opcions addicionals del sistema, faci clic <a href="index.php?module=Administration&action=index" target="_blank">aquí</a>.',
